...
export async function insertTour(tourData: ToursRow) {
    ...
    .insert([tourData]);
    if (error) {
        throw new Error(`An error occurred while trying to insert tour: ${error.message}`);
    }
    const newTour = data;
    return newTour;
}
...
export async function updateTour(id: number, updatedInfo: ToursRow) {
    ...
    if (error) {
        throw new Error(`An error occurred while trying to update tour: ${error.message}`);
    }
    const newTour = data;
    return newTour;
}
...
export async function upsertTour(tourData: ToursRow) {
    ...
    .upsert([tourData]);
    if (error) {
        throw new Error(`An error occurred while trying to upsert tour: ${error.message}`);
    }
    const newTour = data;
    return newTour;
}
...
export async function deleteTour(id: number) {
    ...
    .eq('id', id);
    if (error) {
        throw new Error(`An error occurred while trying to delete tour: ${error.message}`);
    }
